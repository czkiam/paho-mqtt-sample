...
certificates_path = "c:\certificates"
...
mqtt_server_host = "LAPTOP-EP2HMCE3"
mqtt_server_port = 8883
mqtt_keepalive = 60

def on_connect(client, userdata, flags, rc):
    print("Connect result: {}".format(mqtt.connack_string(rc)))
    client.subscribe("test/drone01", qos=2)
...
def on_message(client, userdata, msg):
    ...
    print("Topic: {}. Payload: {}, qos: {}, retain flag: {}".format(
        msg.topic, 
        payload_string,
        msg.qos,
        msg.retain))
...
if __name__ == "__main__":
    client = mqtt.Client(client_id="testdrone01", protocol=mqtt.MQTTv311)
